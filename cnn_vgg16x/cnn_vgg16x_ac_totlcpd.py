...
class cnn_vgg16x_ac_totlcpd(cnn_vgg16x):
    def __init__(self):
        super().__init__()
        self.py_filename = "cnn_vgg16x_ac_totlcpd"
        self.CreateDir()
    ...
    def TrainNet(self):
        ...
        self.DefineModel_textAndNumerics_VGG16x([self.x_train_text.shape[1], self.x_train_numeric.shape[1]],
                                                numclasses, x_train_numeric_ld.shape[1])
        ...
        history_ac = self.model_ac.fit(self.x_train_numeric, x_train_numeric_ld, batch_size=200,
                                       validation_data=(self.x_test_numeric, x_test_numeric_ld), epochs=600)
